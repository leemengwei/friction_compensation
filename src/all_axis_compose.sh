...
#CUDA_VISIBLE_DEVICES=1 python NN_compose.py --data_path=../data/standard_path/realtime-20200414-184219.rec-data-shangxialiao-low.prb-log --time_to_plot=10000
#CUDA_VISIBLE_DEVICES=1 python NN_compose.py --data_path=../data/standard_path/realtime-20200414-185114.rec-data-shangxialiao-meduim.prb-log --time_to_plot=7500
#CUDA_VISIBLE_DEVICES=1 python NN_compose.py --data_path=../data/standard_path/realtime-20200414-185858.rec-data-shangxialiao-high.prb-log --time_to_plot=2500
#


#FINETUNE:
###CUDA_VISIBLE_DEVICES=1 python NN_compose.py --data_path=../data/standard_path/realtime-20200326-171242.rec-data-rrr.prb-log --time_to_plot=35000 --finetune
###CUDA_VISIBLE_DEVICES=1 python NN_compose.py --data_path=../data/standard_path/realtime-20200326-171651.rec-data-testzhixian.prb-log --time_to_plot=35000 --finetune
###
####Local test, repeated
CUDA_VISIBLE_DEVICES=1 python NN_compose.py --data_path=../data/standard_path/realtime-20200413-150531-jiepai-low.rec-data.prb-log --time_to_plot=400 --finetune
CUDA_VISIBLE_DEVICES=1 python NN_compose.py --data_path=../data/standard_path/realtime-20200413-151740-bi-low.rec-data.prb-log --time_to_plot=1500 --finetune
CUDA_VISIBLE_DEVICES=1 python NN_compose.py --data_path=../data/standard_path/realtime-20200413-152042-bi-high.rec-data.prb-log --time_to_plot=1500 --finetune
##CUDA_VISIBLE_DEVICES=1 python NN_compose.py --data_path=../data/standard_path/realtime-20200413-163945-welding-high.rec-data.prb-log --time_to_plot=7500 --finetune
